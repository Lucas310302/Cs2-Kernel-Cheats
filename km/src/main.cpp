...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\CsBunnyHop");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\CsBunnyHop");
...
NTSTATUS DriverEntry() {
	...
	RtlInitUnicodeString(&driver_name, L"\\Driver\\CsBunnyHop");
